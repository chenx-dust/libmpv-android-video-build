...
# libxml2
[ ! -d libxml2 ] && git clone --depth 1 --branch v$v_libxml2 --recursive --shallow-submodules https://gitlab.gnome.org/GNOME/libxml2.git libxml2
...
# vulkan
[ ! -d vulkan ] && git clone --depth 1 --branch vulkan-sdk-$v_vulkan https://github.com/KhronosGroup/Vulkan-Headers vulkan
